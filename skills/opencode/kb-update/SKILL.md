---
name: kb-update
description: Save learned knowledge to the local knowledge base (kb MCP) — architecture decisions, non-obvious behaviors, gotchas, integration patterns, task status. Use when the user asks to remember/store something, when finishing an investigation, or when learning something a fresh agent would need in 3 months.
---
